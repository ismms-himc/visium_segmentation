...
params.jpeg = "$baseDir/cytassist_test/MAGA03_B10_257_1001.jpg"
...
process run_spaceranger_image {
  ...
  path alignment from params.alignment
  ...
  ALIGNMENT=\$(readlink -f $alignment)

  sed -e "s|<M_IMAGE>|\$M_IMAGE|g" -e "s|<V_IMAGE>|\$V_IMAGE|g" -e "s|<ALN>|\$ALIGNMENT|g" $invocation > _input
